...
header.append("CSP Break Even Date - NU")
header.append("CSP Break Even Date - PU")
header.append("CSP Break Even Date - AU")
header.append("EC2ISP Break Even Date - NU")
header.append("EC2ISP Break Even Date - PU")
header.append("EC2ISP Break Even Date - AU")
...
def elaborate_item(csv_row):
    ...
    csv_row.append(f'{ed_nu}')
    csv_row.append(f'{ed_pu}')
    csv_row.append(f'{ed_au}')
    csv_row.append(f'{ed1_nu}')
    csv_row.append(f'{ed1_pu}')
    csv_row.append(f'{ed1_au}')
